...
@Index('IX_moq_request_fulfillment_variant_version_id', ['fulfillmentVariantVersionId'], {})
@Index('PK_moq_request', ['id'], { unique: true })
@Entity('moq_request', { schema: 'public' })
export class MoqRequest {
  ...
  @Column('integer', { name: 'estimate_quantity' })
  ...
  @ManyToOne(() => FulfillmentVariantVersion, (fulfillmentVariantVersion) => fulfillmentVariantVersion.moqRequests, {
    onDelete: 'RESTRICT'
  })
